...
function _G.LLWindow:Constructor()
    ...
    self.clockBg:SetPosition(35, 5)
    self.clockBg:SetSize(260, 17)
    ...
    self.clockLabel:SetPosition(36, 0)
...
function _G.LLWindow:SizeChanged()
    ...
    self.clockBg:SetLeft(35)
    self.clockBg:SetWidth(260)
    self.clockLabel:SetLeft(31)
    self.clockLabel:SetWidth(258)
