...
_G.Events = {
    ...
    [585] = { name = "Pakhán-gebar",       match = "Coffre de Pakhan%-gebar %- Solo",         instance = 54,  tier = "Solo", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [584] = { name = "Council of Shadows", match = "Conseil du Ombres %- Solo",               instance = 54,  tier = "Solo", order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [583] = { name = "Bârlat",             match = "Bârlat l'Audacieux %- Solo",              instance = 54,  tier = "Solo", order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T1 (daily)
    [582] = { name = "Pakhán-gebar",       match = "Coffre de Pakhan%-gebar %- Niveau 1",     instance = 54,  tier = "T1",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [581] = { name = "Council of Shadows", match = "Conseil du Ombres %- Niveau 1",           instance = 54,  tier = "T1",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [580] = { name = "Bârlat",             match = "Bârlat l'Audacieux %- Niveau 1",          instance = 54,  tier = "T1",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T2 (daily)
    [579] = { name = "Pakhán-gebar",       match = "Coffre de Pakhan%-gebar %- Niveau 2",     instance = 54,  tier = "T2",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [578] = { name = "Council of Shadows", match = "Conseil du Ombres %- Niveau 2",           instance = 54,  tier = "T2",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [577] = { name = "Bârlat",             match = "Bârlat l'Audacieux %- Niveau 2",          instance = 54,  tier = "T2",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T3 (daily)
    [576] = { name = "Pakhán-gebar",       match = "Coffre de Pakhan%-gebar %- Niveau 3",     instance = 54,  tier = "T3",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [575] = { name = "Council of Shadows", match = "Conseil du Ombres %- Niveau 3",           instance = 54,  tier = "T3",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [574] = { name = "Bârlat",             match = "Bârlat l'Audacieux %- Niveau 3",          instance = 54,  tier = "T3",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },

    -- Ekal-nêbi, the Fallen Palace — Solo (daily) ---------------------------------------------
    [573] = { name = "Ratúlko",    match = "Gardien sanglant %- Solo",                 instance = 53, tier = "Solo", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [572] = { name = "Barkhuráni", match = "Coffre de la Prêtresse noire %- Solo",     instance = 53, tier = "Solo", order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [571] = { name = "Thothril",   match = "Coffre de l%'Enchevêtreuse %- Solo",       instance = 53, tier = "Solo", order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T1 (daily)
    [570] = { name = "Ratúlko",    match = "Gardien sanglant %- Niveau 1",             instance = 53, tier = "T1",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [569] = { name = "Barkhuráni", match = "Coffre de la Prêtresse noire %- Niveau 1", instance = 53, tier = "T1",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [568] = { name = "Thothril",   match = "Coffre de l%'Enchevêtreuse %- Niveau 1",   instance = 53, tier = "T1",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T2 (daily)
    [567] = { name = "Ratúlko",    match = "Gardien sanglant %- Niveau 2",             instance = 53, tier = "T2",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [566] = { name = "Barkhuráni", match = "Coffre de la Prêtresse noire %- Niveau 2", instance = 53, tier = "T2",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [565] = { name = "Thothril",   match = "Coffre de l%'Enchevêtreuse %- Niveau 2",   instance = 53, tier = "T2",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T3 (daily)
    [564] = { name = "Ratúlko",    match = "Gardien sanglant %- Niveau 3",             instance = 53, tier = "T3",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [563] = { name = "Barkhuráni", match = "Coffre de la Prêtresse noire %- Niveau 3", instance = 53, tier = "T3",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [562] = { name = "Thothril",   match = "Coffre de l%'Enchevêtreuse %- Niveau 3",   instance = 53, tier = "T3",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },

    -- Kôth Rau, the Wailing Hold — Solo (daily) -----------------------------------------------
    [561] = { name = "The Twins", match = "Coffre des jumeaux %- Solo",             instance = 52, tier = "Solo", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [560] = { name = "Ombátha",   match = "Coffre personnel d'Ombatha %- Solo",     instance = 52, tier = "Solo", order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [559] = { name = "Râkdakul",  match = "Offrande de Râkdakul %- Solo",           instance = 52, tier = "Solo", order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T1 (daily)
    [558] = { name = "The Twins", match = "Coffre des jumeaux %- Niveau 1",         instance = 52, tier = "T1",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [557] = { name = "Ombátha",   match = "Coffre personnel d'Ombatha %- Niveau 1", instance = 52, tier = "T1",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [556] = { name = "Râkdakul",  match = "Offrande de Râkdakul %- Niveau 1",       instance = 52, tier = "T1",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T2 (daily)
    [555] = { name = "The Twins", match = "Coffre des jumeaux %- Niveau 2",         instance = 52, tier = "T2",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [554] = { name = "Ombátha",   match = "Coffre personnel d'Ombatha %- Niveau 2", instance = 52, tier = "T2",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [553] = { name = "Râkdakul",  match = "Offrande de Râkdakul %- Niveau 2",       instance = 52, tier = "T2",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    -- T3 (daily)
    [552] = { name = "The Twins", match = "Coffre des jumeaux %- Niveau 3",         instance = 52, tier = "T3",   order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [551] = { name = "Ombátha",   match = "Coffre personnel d'Ombatha %- Niveau 3", instance = 52, tier = "T3",   order = 2, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [550] = { name = "Râkdakul",  match = "Offrande de Râkdakul %- Niveau 3",       instance = 52, tier = "T3",   order = 3, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    ...
    [537]  = { name = "Badharál",                match = "%Œuf monstrueux de Badharal %- Niveau 1",  instance = 50, tier = "T1", order = 1, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [536]  = { name = "Maukhorn",                match = "Coffre de Maukhorn %- Niveau 1",           instance = 50, tier = "T1", order = 2, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [535]  = { name = "The Legion",              match = "Coffre de la Légion %- Niveau 1",          instance = 50, tier = "T1", order = 3, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [534]  = { name = "Zamâktar the Putrescent", match = "Zamâktar le Putride %- niveau 1",          instance = 50, tier = "T1", order = 4, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    -- T2 (weekly Thu)
    [533] = { name = "Badharál",                match = "%Œuf monstrueux de Badharal %- Niveau 2",   instance = 50, tier = "T2", order = 1, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [532] = { name = "Maukhorn",                match = "Coffre de Maukhorn %- Niveau 2",            instance = 50, tier = "T2", order = 2, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [531] = { name = "The Legion",              match = "Coffre de la Légion %- Niveau 2",           instance = 50, tier = "T2", order = 3, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [530] = { name = "Zamâktar the Putrescent", match = "Zamâktar le Putride %- niveau 2",           instance = 50, tier = "T2", order = 4, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    -- T3 (weekly Thu)
    [529] = { name = "Badharál",                match = "%Œuf monstrueux de Badharal %- Niveau 3",   instance = 50, tier = "T3", order = 1, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [528] = { name = "Maukhorn",                match = "Coffre de Maukhorn %- Niveau 3",            instance = 50, tier = "T3", order = 2, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [527] = { name = "The Legion",              match = "Coffre de la Légion %- Niveau 3",           instance = 50, tier = "T3", order = 3, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [526] = { name = "Zamâktar the Putrescent", match = "Zamâktar le Putride %- niveau 3",           instance = 50, tier = "T3", order = 4, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },

    -- Quests: Kingdoms of Harad — Weeklies (weekly Thu) ---------------------------------------
    [525] = { name = "20 Quests",    match = "Distinctions de Mûr Ghala reçues %(%d+/20%)",                        instance = 49, tier = "Weeklies", order = 1, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    [524] = { name = "30 Quests",    match = "Distinctions de Mûr Ghala reçues %(%d+/30%)",                        instance = 49, tier = "Weeklies", order = 2, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    [523] = { name = "6 Instances",  match = "Instances de Mûr Ghala terminées %(%d+/6%)",                   instance = 49, tier = "Weeklies", order = 3, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    ...
    [521] = { name = "Raid",         match = "Instance du raid La Folie de Nagakhêdi terminée", instance = 49, tier = "Weeklies", order = 5, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    ...
    [32] = { name = "6-man",  match = "Don supérieur des Mirdain %- Niveau 3", instance = 7, tier = "T3", order = 1, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [31] = { name = "12-man", match = "Grand don des Mirdain %- Niveau 3",     instance = 7, tier = "T3", order = 2, type = _G.EventTypes.Completions, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },

    -- Missions/Delvings — Weeklies (weekly Thu) ------------------------------------------------
    [30] = { name = "15 Missions",      match = "Missions terminées %(%d+/15%)",                                                instance = 6, tier = "Weeklies", order = 1, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    [29] = { name = "45 Missions",      match = "Missions terminées %(%d+/45%)",                                                instance = 6, tier = "Weeklies", order = 2, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    [28] = { name = "15 Delvings",      match = "Creuser plus profond %(hebdomadaire%)",                                        instance = 6, tier = "Weeklies", order = 3, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [27] = { name = "10 T6+ Delvings",  match = "Excavations de niveau supérieur terminées %(niveau 6 et plus%) %(%d+/10%)",    instance = 6, tier = "Weeklies", order = 4, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    [26] = { name = "Ini Delvings",     match = "reuser plus profond %(hebdomadaire%)",                                         instance = 6, tier = "Weeklies", order = 5, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },

    -- Tasks — Weeklies (weekly Thu) ------------------------------------------------------------
    [25] = { name = "10 Tasks",                   match = "Tâches accomplies %(%d+/10%)",               instance = 5, tier = "Weeklies", order = 1, type = _G.EventTypes.ExtractValue, reset = { days = Weekly, time = 8 }, onlyResetIfDone = true },
    [24] = { name = "Tokens of Heroism",          match = "Tâche %: Jetons d%'héroïsme[^ ]",            instance = 5, tier = "Weeklies", order = 2, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [23] = { name = "Tokens of Heroism (Tier 2)", match = "Tâche %: Jetons d%'héroïsme %(Niveau 2%)",   instance = 5, tier = "Weeklies", order = 3, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [22] = { name = "Tokens of Heroism (Tier 3)", match = "Tâche %: Jetons d%'héroïsme %(Niveau 3%)",   instance = 5, tier = "Weeklies", order = 4, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    ...
    [15] = { name = "Gundabad Motes",         match = "Pièces d'argent de Gundabad contre graines",         instance = 4, tier = "Motes", order = 5, type = _G.EventTypes.Done, reset = { days = {Sunday}, time = 8 }, onlyResetIfDone = false },
    -- Virtues (weekly Thu)
    [14] = { name = "I",       match = "Terminé %:.De ses cendres renaît la vertu %- I[^ ]",              instance = 4, tier = "Virtues", order = 1, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [13] = { name = "II",      match = "Terminé %:.De ses cendres renaît la vertu %- II[^ ]",             instance = 4, tier = "Virtues", order = 2, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [12] = { name = "III",     match = "Terminé %:.De ses cendres renaît la vertu %- III",                instance = 4, tier = "Virtues", order = 3, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [11] = { name = "IV",      match = "Terminé %:.De ses cendres renaît la vertu %- IV",                 instance = 4, tier = "Virtues", order = 4, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [10] = { name = "V",       match = "Terminé %:.De ses cendres renaît la vertu %- V",                  instance = 4, tier = "Virtues", order = 5, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [9] = { name = "VI",      match = "Terminé %:.De ses cendres renaît la vertu %- VI",                  instance = 4, tier = "Virtues", order = 6, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },
    [8] = { name = "Weekly",  match = "Terminé %:.De ses cendres renaît la vertu %(hebdomadaire%)",      instance = 4, tier = "Virtues", order = 7, type = _G.EventTypes.Done, reset = { days = Weekly, time = 8 }, onlyResetIfDone = false },

    -- Naruhel — T1/T2/T3 (daily) --------------------------------------------------------------
    [7] = { name = "Naruhel", match = "Coffre en argent de Naruhel",  instance = 3, tier = "T1", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [6] = { name = "Naruhel", match = "Coffre en or de Naruhel",      instance = 3, tier = "T2", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [5] = { name = "Naruhel", match = "Coffre en mithril de Naruhel", instance = 3, tier = "T3", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },

    -- Thrâng — T1/T2 (daily) ------------------------------------------------------------------
    [4] = { name = "Thrâng", match = "Coffre en argent de Thrâng",  instance = 2, tier = "T1", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
    [3] = { name = "Thrâng", match = "Coffre en or de Thrâng",      instance = 2, tier = "T2", order = 1, type = _G.EventTypes.Completions, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },

    -- Storvâgûn — T1/T2 (daily) ---------------------------------------------------------------
    [2] = { name = "Storvâgûn", match = "Toute petite cassette à babioles de Storvâgûn", instance = 1, tier = "T1", order = 1, type = _G.EventTypes.Done, reset = { days = Daily, time = 8 }, onlyResetIfDone = false },
