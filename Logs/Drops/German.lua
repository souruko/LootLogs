...
--= loot feature is inert on a German client -- no popup, no browser rows, no errors -- rather
--= than matching English names against German chat and silently recording nothing.
--=
